public class HappyFamily {
    public static void main(String[] args) {
        ...
        Pet petAllProperties = new Pet("dog", "Ted", 2, 50, new String[]{"sleep", "eat", "play"});
        petAllProperties.print();

        Pet petEmptyConstructor = new Pet();
        petEmptyConstructor.print();

        Pet pet2Properties = new Pet("cat", "March");
        ...
        Pet cat1 = new Pet("cat", "Danny", 3, 50, new String[]{"sleep", "play"});
        Pet cat2 = new Pet("cat", "Rex", 7, 90, new String[]{"sleep", "eat"});
        Pet dog = new Pet("dog", "Lilu", 1, 95, new String[]{"walk", "play"});
